...
window.onload = function init()
{
    ...
    lightModelLoc = gl.getUniformLocation( program, "lightModel");
    ...
    if(shape == "sphere")
    {
        ...
        for(var i = 0; i < nRows - 1; i++)
        {
            for(var j = 0; j < nColumns - 1; j++)
            {
              ...
              normalsArray.push( xyz1[0], xyz1[1], xyz1[2], 0.0 );
              normalsArray.push( xyz2[0], xyz2[1], xyz2[2], 0.0 );
              normalsArray.push( xyz3[0], xyz3[1], xyz3[2], 0.0 );

              normalsArray.push( xyz1[0], xyz1[1], xyz1[2], 0.0 );
              normalsArray.push( xyz3[0], xyz3[1], xyz3[2], 0.0 );
              normalsArray.push( xyz4[0], xyz4[1], xyz4[2], 0.0 );
            }
        }
    }
    // torus
